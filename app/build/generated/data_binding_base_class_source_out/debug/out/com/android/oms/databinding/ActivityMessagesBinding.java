...
public final class ActivityMessagesBinding implements ViewBinding {
  ...
  private ActivityMessagesBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listView,
  ...
  public static ActivityMessagesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMessagesBinding((ConstraintLayout) rootView, listView, main);
    }
